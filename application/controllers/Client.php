...
class Client extends MY_Controller {
	...
	private function _load_addclient_view() {
		$data = array();
		$data['content'] = 'addclient';
		$this->load->view('layouts/index', $data);
	}

	private function _load_clientsearchresult_view($client_details) {
		$data = array();
	...
	private function _load_clientlist_view() {
		$data = array();
	...
	private function _load_clientedit_view($client_details) {
		$data = array();
