...
class Metakeyword extends MY_Controller {
    ...
    public function _load_metakeyword_view(){
        $data=array();
        $data['content']='metakeywordlist';
        $this->load->view('layouts/index', $data);
    }
    public function _load_add_metakeyword_view($content_pagelist){
        $data=array();
        $data['content_pagelist']=$content_pagelist; 
        $data['content']='addmetakeyword';
        $this->load->view('layouts/index', $data);
    }
    public function _load_edit_metakeyword_view($content_pagelist,$page_meta_detail){
        $data=array();
        $data['content_pagelist']=$content_pagelist;
