                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                            <div class="radio single-row">
                                                ...
                                                <label class='control-label'><strong>Only new FEPI data and keep the prior changes</strong></label>
                                            </div>

                                            <div class="radio single-row">
                                                <input tabindex="3" type="radio"  value="new"  id="new" name="synctype">
                                                <label class='control-label'><strong>Purge the local FEPI data and re-sync all </strong></label>
                                            </div>
