    ...
    <div class="col-lg-12">
        <section class="panel">
                      ...
                      <!--  <header class="panel-heading">
                            Update Metakeyword   <a  href='javascript:history.back()' class='btn btn-success' style="margin-left: 800px;">Back</a>
                        </header>   -->
                      <header class="panel-heading">
                        <div class="col-sm-12">
                        <div class="col-sm-10 no-margin" style="padding-left:0;">
                        <h4> Update Metakeyword   </h4></div>
                        <div class="col-sm-2">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" method="POST" action="<?php echo base_url('metakeyword/update_metakeyword_details');?>">
                                <button type="button" class="btn btn-info" id='addmore'>+Add More</button>   
                                    ...
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <option value="<?php echo $page['title'];?>" <?php if($page['title']==$page_meta_detail['pagename']){ ?> selected="selected" <?php }?>><?php echo $page['title'];?></option>       
                                        <?php }?>
                                        </select>
                                    </div>
                                    <div id='contentdata'> 
                                        <div class='subdata'>    
                                            <div class="form-group">
                                                ...
                                                ?>
                                                   <option value="<?php echo $val; ?>" <?php if($val==$page_meta_detail['keyword']){ ?> selected="selected" <?php }?>><?php echo $val; ?></option> 
                                                <?php }?>
                                                </select>
                                                </span>
                                            </div>
                                ...
                                <input type="hidden" name="pageid" id="pageid" value="<?php echo $page_meta_detail['id']?>">  
